...
describe("urlToName", () => {
  it("strips https:// scheme", () => {
    expect(urlToName("https://harishkannanjs.vercel.app")).toBe("harishkannanjs.vercel.app")
  })
  ...
  it("leaves a bare host unchanged", () => {
    expect(urlToName("harishkannanjs.vercel.app")).toBe("harishkannanjs.vercel.app")
  })
})
