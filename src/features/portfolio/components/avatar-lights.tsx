...
export function AvatarLights({
  ...
  return (
    <div
      ...
      {...props}
    >
      <AvatarLayer className="opacity-100 in-[.dark]:opacity-0 in-[.light[data-avatar-lights=on]]:opacity-0">
        <AvatarImage
...
function AvatarLayer({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div className={cn("absolute inset-0 opacity-0", className)} {...props} />
  )
}
